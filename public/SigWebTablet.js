...
function isX() {
  ...
  function SetDisplayXSize (v) {
    //console.log('en SetDisplayXSize argv=', v);
...
//module.exports = { isX,
//  SetDisplayXSize, SetDisplayYSize, SetTabletState, SetJustifyMode,
//  NumberOfTabletPoints, SetSigCompressionMode, GetSigString,
//  SetImageXSize, SetImageYSize, SetImagePenWidth, GetSigImageB64
//}
